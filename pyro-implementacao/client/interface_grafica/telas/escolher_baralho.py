...
class EscolherBaralho(arcade.View):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if len(self.baralhos) >= 1 and LARGURA_TELA // 2 - 425 < x < LARGURA_TELA // 2 + 425 and 425 < y < 575:
            self.baralho_selecionado = 1
            
        elif len(self.baralhos) >= 2 and LARGURA_TELA // 2 - 425 < x < LARGURA_TELA // 2 + 425 and 255 < y < 405:
            self.baralho_selecionado = 2
            
        elif len(self.baralhos) == 3 and LARGURA_TELA // 2 - 425 < x < LARGURA_TELA // 2 + 425 and 85 < y < 235:
